...
.input-group--slider
  &.input-group--light
    slider-theme($slider-light-off,
      $slider-light-focus-off,
  ...
  &.input-group--dark
    slider-theme($slider-dark-off,
      $slider-dark-focus-off,
...
.input-group
  &--ticks:hover
    .slider__track__container:after, .slider__ticks
      opacity: 1
